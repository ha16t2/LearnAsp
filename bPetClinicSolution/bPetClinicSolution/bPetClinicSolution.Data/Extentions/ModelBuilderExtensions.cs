...
using bPetClinicSolution.Data.Enums;
...
namespace bPetClinicSolution.Data.Extentions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            // any guid
            var roleId = new Guid("95C68DD1-1A36-4B06-BF6E-47DE25DC6515") ;
            var adminId = new Guid("9E820B10-8555-4FCE-9835-149E4F57A9A7");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "ntha5531@gmail.com",
                NormalizedEmail = "ntha5531@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "Nguyenthiha@123"),
                SecurityStamp = string.Empty,
                FirstName = "Ha",
                LastName = "Nguyen",
                Dob = new DateTime(1997, 02, 25)
            });
